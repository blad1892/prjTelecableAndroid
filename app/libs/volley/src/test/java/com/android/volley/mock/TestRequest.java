...
public class TestRequest {
    ...
    /** Test example of a GET request UsuarioRepositorio the deprecated style. */
    ...
    /** Test example of a POST request UsuarioRepositorio the deprecated style. */
    ...
    /** Test example of a GET request UsuarioRepositorio the new style. */
    ...
    /**
     * Test example of a POST request UsuarioRepositorio the new style.  In the new style, it is possible
    ...
    /** Test example of a POST request UsuarioRepositorio the new style with a body. */
    ...
    /**
     * Test example of a PUT request UsuarioRepositorio the new style.  In the new style, it is possible to have a
     * PUT with no body.
     */
    ...
    /** Test example of a PUT request UsuarioRepositorio the new style with a body. */
    ...
    /** Test example of a DELETE request UsuarioRepositorio the new style. */
    ...
    /** Test example of a HEAD request UsuarioRepositorio the new style. */
    ...
    /** Test example of a OPTIONS request UsuarioRepositorio the new style. */
    ...
    /** Test example of a TRACE request UsuarioRepositorio the new style. */
    ...
    /** Test example of a PATCH request UsuarioRepositorio the new style. */
    ...
    /** Test example of a PATCH request UsuarioRepositorio the new style with a body. */
